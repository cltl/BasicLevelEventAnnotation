...
let accepted_versions = ["sport", "other", "test"];
...
const json_path_annotations = `data/${version}/annotations/annotations.json`;
...
app.get('/clicked', function (req, res) {
    ...
    let subevents = req.query["subevents"];

    // update JSON and write to disk
    jsonContent[identifier] = [participants, subevents];
